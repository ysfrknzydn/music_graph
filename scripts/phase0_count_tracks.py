...
liked_tracks = load_or_fetch('data/liked_tracks.json', lambda: item_collector(sp.current_user_saved_tracks()))

playlist_tracks = load_or_fetch('data/playlist_tracks.json', fetch_all_playlist_tracks) 

short_term = load_or_fetch('data/short_term.json', lambda: item_collector(sp.current_user_top_tracks(time_range="short_term")))
medium_term = load_or_fetch('data/medium_term.json', lambda: item_collector(sp.current_user_top_tracks(time_range="medium_term")))
long_term = load_or_fetch('data/long_term.json', lambda: item_collector(sp.current_user_top_tracks(time_range="long_term")))
top_tracks = short_term + medium_term + long_term

recent_tracks = load_or_fetch('data/recent_tracks.json', lambda: item_collector(sp.current_user_recently_played()))
